        ...
        <div className="flex flex-col sm:flex-row  flex-1 sm:mt-4 mt-8
          sm:justify-center  h-full sm:h-[18rem]  w-full  border-red-500  gap-4 ">
            ...
            <div className="mt-4 w-full flex items-center justify-center gap-5">
                <button className='border w-30 rounded-md text-md px-2 py-1 text-yellow-400 hover:text-white border-yellow-400 ' >Add to Cart</button>
            ...
            {/* right div for details and contents */}
             ...
             rounded-lg bg-gray-800  sm:max-h-[20rem] mt-[4rem] sm:mt-0 p-4 sm:p-8">
         ...
         flex  items-center   gap-3 pt-6 text-emerald-400">Price
           ...
           <span className='font-medium  sm:text-7xl mt-auto text-gray-400 '> {productDetail?.price}</span>
           </p>
